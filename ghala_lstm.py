# -*- coding: utf-8 -*-
"""
Created on Mon Apr 17 14:34:54 2023
...
for i in range(1,9):
    if i==1:
        ...
        dataset = pd.read_csv('C:\\Users\\Lenovo\\Desktop\\Excel Data\\khanpur\\khanpur_11.csv')
        ...
        def create_model(neurons=16, dropout_rate=0.2, optimizer='adam', activation='relu'):
            ...
            return model
        model = KerasRegressor(build_fn=create_model, neurons=16, 
                               dropout_rate=0.2, optimizer='adam', activation='relu')
        ...
        best_model.fit(X_train, y_train, epochs=best['epochs'], batch_size=best['batch_size'], 
        ...
        df.to_csv("C:\\Users\\Lenovo\\Desktop\\Excel Data\\khanpur\\k\\rnn\\klstm_pred11.csv")
        df1 = pd.DataFrame(y_pred_1)
        df1.to_csv("C:\\Users\\Lenovo\\Desktop\\Excel Data\\khanpur\\k\\rnn\\klstm_pred_111.csv")
        y_test.to_csv("C:\\Users\\Lenovo\\Desktop\\Excel Data\\khanpur\\k\\rnn\\klstm_test11.csv")
        y_train.to_csv("C:\\Users\\Lenovo\\Desktop\\Excel Data\\khanpur\\k\\rnn\\klstm_train11.csv")
    elif i==2:
        dataset = pd.read_csv('C:\\Users\\Lenovo\\Desktop\\Excel Data\\garudeshwar\\garudeshwar_19.csv')
        dataset = dataset.set_index(['Date'])
        Train = dataset.iloc[:10958,:]
        Test = dataset.iloc[10958:,:]
        X_train = Train.iloc[:,:-1]
